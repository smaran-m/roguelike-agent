export enum GameErrorCode {
  ...
  AUDIO_CONTEXT_REQUIRED = 'AUDIO_CONTEXT_REQUIRED',
  SOUND_DEFINITION_NOT_FOUND = 'SOUND_DEFINITION_NOT_FOUND',
  INVALID_SOUND_TYPE = 'INVALID_SOUND_TYPE',
  AUDIO_SYNTHESIS_FAILED = 'AUDIO_SYNTHESIS_FAILED',
  
  // World Picker errors
  WORLD_PICKER_INIT_FAILED = 'WORLD_PICKER_INIT_FAILED',
  WORLD_SELECTION_FAILED = 'WORLD_SELECTION_FAILED',
  WORLD_SELECTION_ERROR = 'WORLD_SELECTION_ERROR'
}
